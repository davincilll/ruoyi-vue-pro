package cn.iocoder.yudao.framework.ability.websocket.config;

import cn.iocoder.yudao.framework.ability.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import cn.iocoder.yudao.framework.ability.mq.redis.core.RedisMQTemplate;
import cn.iocoder.yudao.framework.ability.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.iocoder.yudao.framework.ability.websocket.core.listener.WebSocketMessageListener;
import cn.iocoder.yudao.framework.ability.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.iocoder.yudao.framework.ability.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.iocoder.yudao.framework.ability.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.iocoder.yudao.framework.ability.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.iocoder.yudao.framework.ability.websocket.core.session.WebSocketSessionManager;
import cn.iocoder.yudao.framework.ability.websocket.core.session.WebSocketSessionManagerImpl;
